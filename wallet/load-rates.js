...
(function(){
  var get, ref$, map, groupBy, objToPairs, pairsToObj, flatten, filter, task, run, div, parseRateString, parseUsdInfo, makeLoader, invalidUrl, createTask, extractVal, modifyItem, setVal, setVals, getData, loadRates, toString$ = {}.toString, slice$ = [].slice;
