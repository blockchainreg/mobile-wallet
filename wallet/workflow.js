...
(function () {
  ...
  Parallel = (function () {
    ...
    var prototype = Parallel.prototype,
  ...
  makeParallel = function (o, val, success) {
    ...
    if (tasks.length <= max) {
      ...
      head = pairsToObj(take(max)(tasks));
      tail = pairsToObj(drop(max)(tasks));
  ...
  go = curry$(function (fns, val) {
    ...
    processVal = function (nval) {
      ...
      next = go(fns);
      if (
        toString$.call(nval).slice(8, -1) === 'Object' &&
        toString$.call(nval.then).slice(8, -1) === 'Function'
      ) {
