...
(function () {
  var ref$, sortBy, reverse, filter, find, keys, map, take, makeArray, filterTxs;
  ...
  const applyTransactions = function (store) {
    ...
    var end = Date.now();
    console.log(`apply txs took ${(end - start) / 1000} seconds`);
  };
