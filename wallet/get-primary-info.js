...
(function () {
  ...
  module.exports = function (store) {
    ...
    links = (ref$ = coin != null ? coin.links : void 8) != null ? ref$ : [];
    color =
      (ref$ = coin != null ? coin.color : void 8) != null ? ref$ : '#000000';
    app = (ref$ = themes[store.theme]) != null ? ref$ : themes.dark;
    return {
      app: app,
      branding: branding,
      links: links,
