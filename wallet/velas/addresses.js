...
(function () {
  var swappingAddresses, addresses;
  swappingAddresses = require('../swapping/addresses.js');
  addresses = {
    mainnet: {
  ...
  importAll$(addresses.mainnet, swappingAddresses.mainnet);
  importAll$(addresses.testnet, swappingAddresses.testnet);
