...
class VelasStaking {
  ...
  async getStakingValidators() {
    ...
    for (var i in validators) {
      ...
      validators[i].stake = `${
        Math.round((validators[i].activatedStake / this.sol) * 100) / 100
      } VLX`;
    }
    return validators;
  }
    ...
    for (let i = 0; i < 1000; i++) {
      ...
      if (
        this.accounts.filter((item) => {
          return item.address === stakeAccountWithSeed.toBase58();
        }).length === 0
      ) {
        return i.toString();
      }
  ...
  async checkSeed(base58PublicKey) {
    ...
    for (let i = 0; i < 1000; i++) {
      ...
      if (stakeAccountWithSeed.toBase58() === base58PublicKey)
        return `stake:${i}`;
    }
      ...
      if (
        deepEq$(
          typeof item != 'undefined' && item !== null
            ? (ref$ = item.account) != null
              ? (ref1$ = ref$.data) != null
                ? (ref2$ = ref1$.parsed) != null
                  ? (ref3$ = ref2$.info) != null
                    ? (ref4$ = ref3$.meta) != null
                      ? (ref5$ = ref4$.authorized) != null
                        ? ref5$.staker
                        : void 8
                      : void 8
                    : void 8
  ...
  async getStakingAccounts(accounts) {
    ...
    for (var i in accounts) {
      ...
      rent =
        (ref$ = accounts[i].account) != null
          ? (ref1$ = ref$.data) != null
            ? (ref2$ = ref1$.parsed) != null
              ? (ref3$ = ref2$.info) != null
                ? (ref4$ = ref3$.meta) != null
                  ? ref4$.rentExemptReserve
                  : void 8
                : void 8
              : void 8
            : void 8
      ...
      accounts[i].address = accounts[i].pubkey.toBase58();
      accounts[i].key = accounts[i].address;
      accounts[i].balance = rent
        ? `${
            (Math.round((accounts[i].account.lamports - rent) / this.sol) *
              100) /
            100
          } VLX`
        : `-`;
      accounts[i].rent = rent
        ? `${Math.round((rent / this.sol) * 100) / 100} VLX`
        : `-`;
      ...
      if (
        ...
        const activationEpoch = Number(
          (ref$ = accounts[i].account) != null
            ? (ref1$ = ref$.data) != null
              ? (ref2$ = ref1$.parsed) != null
                ? (ref3$ = ref2$.info) != null
                  ? ref3$.stake.delegation.activationEpoch
                  : void 8
                : void 8
              : void 8
            : void 8
        ...
        const deactivationEpoch = Number(
          (ref$ = accounts[i].account) != null
            ? (ref1$ = ref$.data) != null
              ? (ref2$ = ref1$.parsed) != null
                ? (ref3$ = ref2$.info) != null
                  ? ref3$.stake.delegation.deactivationEpoch
                  : void 8
                : void 8
              : void 8
            : void 8
        ...
        if (
          ...
          activationEpoch === this.max_epoch
        ) {
  ...
  async getParsedProgramAccounts() {
    ...
    for (var a in accounts) {
      var ref$, ref1$, ref2$, ref3$, ref4$, ref5$;
      if (
        ((ref$ = accounts[a].account) != null
          ? (ref1$ = ref$.data) != null
            ? (ref2$ = ref1$.parsed) != null
              ? (ref3$ = ref2$.info) != null
                ? (ref4$ = ref3$.stake) != null
                  ? ref4$.delegation
                  : void 8
                : void 8
              : void 8
  ...
  async getInfo() {
    ...
    for (var s in this.accounts) {
      if (this.accounts[s].validator !== '-') {
        if (!stakes[this.accounts[s].validator])
          stakes[this.accounts[s].validator] = [];
    ...
    for (var i in this.validators) {
      this.validators[i].delegators =
        delegators[this.validators[i].votePubkey] || 0;
