...
(function(){
	...
	module.exports = function(store){
		var web3, network, stakingAddress, validatorSetAddress, blockRewardAddress, developmentContractAddress, resolverContractAddress, homeBridgeAddress, foreignBridgeAddress, ERC20BridgeToken, EvmToNativeBridgeAddress, web3Solana, networks, api;
		...
		api = {
			...
			ValidatorSet: web3.eth.contract(abis.ValidatorSet).at(validatorSetAddress),
			BlockReward: web3.eth.contract(abis.BlockReward).at(blockRewardAddress),
			Development: web3.eth.contract(abis.Development).at(developmentContractAddress),
