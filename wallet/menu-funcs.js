...
(function(){
  var ref$, filter, find, cut, money, seed, useNetwork, check, navigate, getPrimaryInfo, copyToClipboard, confirm, prompt, getLang, bip39, generateWallet, state, adjustColor, buildSchema, out$ = typeof exports != 'undefined' && exports || this;
  ...
  module.exports = function(store, web3t){
    var current, lock, refresh, changeSeed, saveSeed, lang, editSeed, cancelTry, enterPin, generate, switchNetwork, activateS, activateS1, activateS2, activateS3, info, primaryColor, walletStyle, openAccount, closeAccount, accountLeft, accountRight, changeAccountIndex, exportPrivateKey;
    ...
    exportPrivateKey = function(){
      return prompt(store, lang.privateKeyEnterPin, function(pin){
        ...
        return prompt(store, lang.privateKeyEnterCoin, function(tokenInput){
          var token, wallets, ref$, ref1$, wallet, message, this$ = this;
