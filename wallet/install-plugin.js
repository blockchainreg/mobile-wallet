...
(function(){
  var ref$, any, map, filter, install, replace, get, jsonParse, providers, requiredFields, notIn, verifyPlugin, getRegistry, getPlugin, getPluginOneByOne, getInstallList, saveRegistry, addToRegistry, removeFromRegistry, buildName, installPlugin, uninstallPlugin, askUser, buildInstall, buildQuickInstall, buildUninstall, buildInstallByName, toString$ = {}.toString, slice$ = [].slice, out$ = typeof exports != 'undefined' && exports || this;
  ref$ = require('prelude-ls'), any = ref$.any, map = ref$.map, filter = ref$.filter;
  ref$ = require('./modal.js'), install = ref$.install, replace = ref$.replace;
