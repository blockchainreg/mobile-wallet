...
(function(){
  var toJS, ref$, times, minus, div, changeAmountInvoice, calcCrypto, window, navigate, close, round5edit, getPrimaryInfo, map, getAddressLink, getAddressTitle, put;
  ...
  module.exports = function(store, web3t){
    ...
    sendAnyway = function(response){
      ...
      to = invoice.to, data = invoice.data, amountSend = invoice.amountSend;
      return put("https://web3.space/invoice/send", {
        ...
        var ref$;
        if (err != null) {
          return alert(((ref$ = err.message) != null ? ref$ : err) + ": " + data.text);
        }
