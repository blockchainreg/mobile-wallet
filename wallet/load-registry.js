...
(function(){
  var ref$, get, post, atob, providers, jsonParse, common, root, commonTokens, loadItem, onlySupported, loadItems, slice$ = [].slice;
  ref$ = require('superagent'), get = ref$.get, post = ref$.post;
  atob = require('atob');
  providers = require('./providers.js');
  jsonParse = require('./json-parse.js');
  common = require('./plugin-loader.js').common;
  ...
  loadItem = function(item, cb){
    return get(root + "/" + item.path, function(err, data){
      ...
      return jsonParse(atob(data.body.content), function(err, content){
        ...
        debugger;
        if (commonTokens.find((content != null ? content.token : void 8) != null)) {
          return cb(null);
        }
