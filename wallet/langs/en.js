...
(function(){
  module.exports = {
    ...
    close: "Close",
    oops: "Oops!",
    seedNotify: "Click 'Print' and print out paper instructions and write down your 24 words seed carefuly. Anyone with access to your recovery phrase could take your assets, store it securely. We do not keep a backup of your 24 words, if you lose it all coins in your wallet will be gone forever!",
    seedNotifyPrint: "Print",
    done: "Done",
    validPin: "Enter a valid password (6-digit)",
