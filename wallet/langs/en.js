...
(function () {
  module.exports = {
    ...
    setup: 'Setup',
    pinInfo:
      'Please make sure to use a pin you remember. You have 7 tries. After that, the wallet will reset and you will need to restore the wallet from your original seed phrase',
    enterPin: 'Enter Password',
    secretPhrase: 'Secret Phrase',
    secretPhraseWarning:
      'Your 12-word backup phrase. Make sure you view this in private. Anyone with this backup phrase can gain full access to your funds. DO NOT store publicly or share it with anyone.',
    secretPhraseChange:
      'If you edit these words, you will effectivelty change your private seed phrase. This can lead to the loss of your old wallet and the associated coins.',
    save: 'Save',
    yourNickname: 'Your Nickname',
    yourNicknameInfo:
      'Create and attach a nickname, email, or phone number to your account. Share it with friends. They will use your nickname to find your crypto-address',
    switchAccountIndex: 'Switch Account Index',
    forAdvancedUsers: 'For advanced users only.',
    switchAccountInfo:
      'Generate multiple unique addresses by switching the account index. By default, you have an index of 1. The range is adjustable to 0-2, 147,483,647',
    exportPrivateKey: 'Export PRIVATE KEY',
    exportPrivateKeyWarning:
      'Private keys prove ownership of assets associated with a particular wallet address. Use caution when exporting your private keys. Anyone with your keys can gain full access to your funds.',
    showSecret: 'Show',
    ...
    newSeedWarning:
      "Click 'Print' and print out paper instructions and write down your 24 words seed carefuly. Anyone with access to your recovery phrase has full access to your wallet, store it securely. We do not keep a backup of your 24 words, if you lose it your wallet could be comprimised",
    receive: 'Receive',
    received: 'Received',
    history: 'History',
    topup: 'Topup',
    ...
    privateKeyEnterCoin:
      'Enter the coin acronym that you wish to reveal the private keys for. Example: BTC, ETH, GBX',
    yourWallets: 'Wallets',
    ...
    invoice: 'Invoice',
    seedWarning:
      'We found some problems in your initial phrase that can lead to zero balances. We can try to solve the formatting problem by clicking this button',
    ...
    lock: 'Lock',
    phraseSafePlace:
      'Please confirm that you have saved this phrase in safe place?',
    ...
    seedNotify2:
      'We do not keep a backup of your 24 words. please store them securely, if you lose them we cannot recover your wallet for you. ',
