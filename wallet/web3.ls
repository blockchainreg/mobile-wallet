...
require! {
    ...
    \./guid.js
    \./send-form.js : { wait-form-result }
    \./calc-amount.js : { change-amount }
    \./math.js : { div, plus, times }
    \protect
    \./navigate.js
    \./use-network.js
    \./api.ls : { get-balance }
    \./install-plugin.js : { build-install, build-uninstall, build-install-by-name, build-quick-install }
    \./refresh-account.js : { background-refresh-account, set-account }
    \web3 : \Web3
    \../api/ethnamed.js
    \./get-record.js
    \./set-page-theme.js
    \./mirror.js
    \./plugin-loader.js : { get-coins }
}
state =
    time: null
