...
(function(){
  var Ethnamed, abi, ref$, put, get, post, sha3num, url, getVerifyEmailUrl, jsonParse, toHex, getContractInstance, extractSignature, getDomain, verifyEmail, getAccessKey, getPaidTransaction, getFreeTransaction, builderSetupRecord, builderWhois, builderVerifyRecord, builderSendTo, toString$ = {}.toString;
  Ethnamed = require('./addresses.json').Ethnamed;
  abi = require('./Ethnamed.abi.json');
  ref$ = require('../web3t/providers/superagent.js'), put = ref$.put, get = ref$.get, post = ref$.post;
