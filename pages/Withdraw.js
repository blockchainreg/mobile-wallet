  ...
  return (
    <View style={styles.inputContainerRadio}>
      <View style={styles.radioField}>
        <TouchableOpacity
          style={
            checked === "slow" ? styles.borderRadioCheck : styles.borderRadio
          }
        ...
        >
          <View style={styles.radioField}>
            ...
            <Text
              style={
                checked === "slow" ? styles.txtRadioCheck : styles.txtRadio
              }
            >
              Slow
            </Text>
          ...
          <Item style={styles.borderItemRadio}>
            <Input
              ...
              style={
                checked === "slow"
                  ? styles.inputStyleRadioCheck
                  : styles.inputStyleRadio
              }
      ...
      <View style={styles.radioField}>
        <TouchableOpacity
          style={
            checked === "custom" ? styles.borderRadioCheck : styles.borderRadio
          }
        ...
        >
          <View style={styles.radioField}>
            ...
            <Text
              style={
                checked === "custom" ? styles.txtRadioCheck : styles.txtRadio
              }
            >
              Custom
            </Text>
      ...
      <TouchableOpacity
        style={
          checked === "fast" ? styles.borderRadioCheck : styles.borderRadio
        }
      ...
      >
        <View style={styles.radioField}>
          ...
          />
          <Text
            style={checked === "fast" ? styles.txtRadioCheck : styles.txtRadio}
          >
            Fast
          </Text>
        </View>
...
export default ({ store, web3t }) => {
  ...
  const InputAddressWithdraw = ({ send }) => (
    <Item style={styles.borderItem}>
      ...
      >
        <Image source={Images.scanImage} style={styles.sizeIconBtn1} />
      </TouchableOpacity>
    </Item>
  );

  const SendButton = ({ send, error }) => btnWithdraw({ store, web3t });
