...
const LocalAuthListView = ({ store }) => {
  ...
  return (
    ...
    >
      ...
      <Body style={styles.heightListItem}>{touchFinger()}</Body>
    ...
    <View style={styles.viewFlex}>
      ...
      <Content>
        ...
        <ListItem
          ...
          onPress={() => {
            Linking.openURL(
              `https://raw.githubusercontent.com/askucher/expo-web3/dev/Privacy.md`
            );
          }}
          underlayColor={Images.velasColor2}
          style={styles.heightListItem}
        ...
        >
          ...
          <Body style={styles.heightListItem}>{PickerSetLang({ store })}</Body>
          <Right style={styles.heightListItem} />
        </ListItem>
        ...
        >
          <Text style={[styles.styleTxtSeparator, { textAlign: 'center' }]}>
            {lang.version} {Constants.nativeAppVersion}
          </Text>
        </Separator>
