...
(function(){
  var mainnet, ethnamed, ropsten, kovan, color, testnet, type, enabled, name, nickname, walletIndex, token, market, image, usdInfo, out$ = typeof exports != 'undefined' && exports || this;
  out$.mainnet = mainnet = {
    decimals: 18,
    txFee: '0.0014',
    txFeeOptions: {
  ...
  out$.market = market = "https://api.coinmarketcap.com/data-api/v3/cryptocurrency/detail/chart?id=1027&range=ALL";
