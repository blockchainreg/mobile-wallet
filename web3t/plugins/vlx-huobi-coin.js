...
(function () {
  ...
  out$.mainnet = mainnet = {
    ...
    /* Used in getHomeFee wallet method */ HOME_BRIDGE:
      '0xa480B124990a262Cc1e4937e2f6084FEe75e781B',
    txFeeIn: 'huobi',
    txBridgeFeeIn: 'ht',
    group: 'Heco',
    networks: {
  ...
  out$.testnet = testnet = {
    ...
    /* Used in getHomeFee wallet method */ HOME_BRIDGE:
      '0x729900a7db6bC1dAb1C2c953791C232Fb2A996Cb',
    txFeeIn: 'huobi',
    txBridgeFeeIn: 'ht',
    group: 'Heco',
    networks: {
