...
(function(){
  var btc, dash, eth, etc, symblox, ltc, usdt, native, ref$, objToPairs, pairsToObj, filter, onlyCoins, extendCoins, toString$ = {}.toString;
  ...
  native = require('./plugins/sol-coin.js');
