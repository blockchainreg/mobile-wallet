...
(function () {
  ...
  (ref$ = require('./example-2-create_accounts.ls')),
    (createBtcAccount = ref$.createBtcAccount),
    (createLtcAccount = ref$.createLtcAccount),
    (createSttAccount = ref$.createSttAccount);
