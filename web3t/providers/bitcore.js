...
(function () {
  ...
  calcFeePerByte = function (config, cb) {
    ...
    return createTransaction(
      ...
      function (err, data) {
        ...
        infelicity = 1;
        return get(getApiUrl(network) + '/fee/6')
          .timeout({
            deadline: deadline,
          })
          .end(function (err, data) {
            ...
            vals =
              data != null && err == null ? values(data.body) : [0.0024295];
  ...
  calcDynamicFee = function (arg$, cb) {
    ...
    network =
      ((ref$ = global.store) != null
        ? (ref1$ = ref$.current) != null
          ? ref1$.network
          : void 8
        : void 8) || 'mainnet';
    return get(getApiUrl(network) + '/fee/6')
  ...
  getOutputs = curry$(function (arg$, cb) {
    ...
    url = network.api.url;
    return get(getApiUrl(network) + '/address/' + address + '/?unspent=true')
      .timeout({
        deadline: 5000,
      })
      .end(function (err, data) {
        ...
        return (function (it) {
          ...
          map(
            ...
            })(each(addAmount(network))(data.body))
          )
        );
      });
  });
  ...
  out$.getTotalReceived = getTotalReceived = function (arg$, cb) {
    ...
    return get(getApiUrl(network) + '/address/' + address + '/totalReceived')
      .timeout({
        deadline: 5000,
      })
      .end(function (err, data) {
  ...
  out$.getUnconfirmedBalance = getUnconfirmedBalance = function (arg$, cb) {
    ...
    return get(
      getApiUrl(network) + '/address/' + address + '/unconfirmedBalance'
    )
      .timeout({
        deadline: 5000,
      })
  ...
  out$.getBalance = getBalance = function (arg$, cb) {
    ...
    return get(getApiUrl(network) + '/address/' + address + '/balance')
      .timeout({
        deadline: 5000,
      })
      .end(function (err, data) {
  ...
  out$.getTransactions = getTransactions = function (arg$, cb) {
    ...
    return get(getApiUrl(network) + '/address/' + address + '/txs?limit=100')
      .timeout({
        deadline: 5000,
      })
      .end(function (err, data) {
  ...
  getValue = function (outputs, receiver) {
    ...
    return (ref$ = receiverData != null ? receiverData.value : void 8) != null
      ? ref$
      : 0;
  };
  cache = {
    ...
    return get(getApiUrl(network) + '/tx/' + mintTxid + '/coins')
      ...
      .end(function (err, _coins) {
        ...
        return jsonParse(_coins.text, function (err, result) {
          ...
          return get(getApiUrl(network) + '/tx/' + mintTxid)
            .timeout({
              deadline: 5000,
            })
            .end(function (err, data) {
