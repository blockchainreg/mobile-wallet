...
(function () {
  ...
  out$.getTransactions = getTransactions = function (arg$, cb) {
    ...
    return get(network.api.apiUrl + '/account?address=' + address)
      .timeout({
        deadline: deadline,
      })
          ...
          return get(
            ...
            .end(function (err, data) {
              ...
              return jsonParse(data.text, function (err, result) {
                ...
                txs = map(transformTransfer(network))(result.transfers);
                return cb(null, txs);
              });
            });
        });
    ...
    return getBalance(
      ...
      function (err, xemBalance) {
        ...
        transactionEntity = nem.model.transactions.prepare(
          'transferTransaction'
        )(common, transferTransaction, network.id);
        kp = nem.crypto.keyPair.create(
          nem.utils.helpers.fixPrivateKey(account.privateKey)
        );
        serialized =
  ...
  out$.pushTx = pushTx = curry$(function (arg$, cb) {
    ...
    endpoint = nem.model.objects.create('endpoint')(
      network.api.nodeAddress,
      network.api.nodePort
    );
    ...
    return nem.com.requests.transaction
      .announce(endpoint, rawtx)
      .then(success, failed);
  });
