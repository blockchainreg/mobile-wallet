...
(function () {
  ...
  (ref$ = require('ripple-keypairs')),
    (deriveKeypair = ref$.deriveKeypair),
    (deriveAddress = ref$.deriveAddress),
    (generateSeed = ref$.generateSeed);
  big = require('big.js');
  ...
  out$.getTransactions = getTransactions = function (arg$, cb) {
    ...
    return query(data, function (err, res) {
      ...
      txs = map(transformTx)(res.transactions);
      return cb(null, txs);
    });
  };
