...
(function(){
  var stringify, ref$, filter, map, foldl, each, uniqueBy, plus, minus, times, div, fromHex, $toHex, get, post, Web3, Tx, BN, hdkey, bip39, jsonParse, deadline, bignumber, getEthereumFullpairByIndex, makeQuery, getGasEstimate, calcFee, getKeys, round, toHex, transformTx, getTransactions, getDec, calcGasPrice, tryGetLateest, getNonce, isAddress, createTransaction, checkDecodedData, pushTx, checkTxStatus, getTotalReceived, getUnconfirmedBalance, getBalance, getMarketHistoryPrices, out$ = typeof exports != 'undefined' && exports || this, toString$ = {}.toString;
  ...
  getGasEstimate = function(config, cb){
    var network, feeType, account, amount, to, data, dec, from, $data, val, value, query;
  ...
  transformTx = curry$(function(network, t){
    ...
    fee = (function(){
      ...
      default:
        return div(times((ref$ = t != null ? t.cumulativeGasUsed : void 8) != null ? ref$ : 0, t.gasPrice), dec);
      }
    }());
    return {
      network: network,
  ...
  out$.createTransaction = createTransaction = curry$(function(arg$, cb){
    var network, account, recipient, amount, amountFee, data, feeType, txType, chainId, gasPrice, dec, privateKey;
    network = arg$.network, account = arg$.account, recipient = arg$.recipient, amount = arg$.amount, amountFee = arg$.amountFee, data = arg$.data, feeType = arg$.feeType, txType = arg$.txType, chainId = arg$.chainId, gasPrice = arg$.gasPrice;
    dec = getDec(network);
