...
(function(){
  var stringify, ref$, filter, map, foldl, each, uniqueBy, plus, minus, times, div, fromHex, get, post, Web3, Tx, BN, hdkey, bip39, jsonParse, deadline, bignumber, getEthereumFullpairByIndex, makeQuery, calcFee, getKeys, round, toHex, transformTx, getTransactions, getDec, calcGasPrice, tryGetLateest, getNonce, isAddress, createTransaction, checkDecodedData, pushTx, checkTxStatus, getTotalReceived, getUnconfirmedBalance, getBalance, getMarketHistoryPrices, out$ = typeof exports != 'undefined' && exports || this, toString$ = {}.toString;
