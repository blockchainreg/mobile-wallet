...
(function () {
  ...
  listAccounts = function (arg$, cb) {
    ...
    return asCallback(eos.getKeyAccounts(publicKey), function (err, data) {
      ...
      names = (ref$ = data.account_names) != null ? ref$ : [];
  ...
  out$.getKeys = getKeys = function (arg$, cb) {
    ...
    return listAccounts(
      ...
      function (err, accounts) {
        ...
        address =
          (ref$ = accounts != null ? accounts[0] : void 8) != null
            ? ref$
            : noAccount;
        return cb(null, {
          publicKey: publicKey,
  ...
  out$.getTransactions = getTransactions = function (arg$, cb) {
    ...
    return get(
      network.api.apiUrl +
        '/api?module=account&action=get_account_related_trx_info&apikey=' +
        apikey +
        '&account=' +
        accountName +
        '&page=1&size=2&transaction_type=3',
      function (err, data) {
        ...
        list =
          (ref$ =
            (ref1$ = data.body.data) != null ? ref1$.trace_list : void 8) !=
          null
            ? ref$
            : [];
        transformed = map(transform(network))(list);
  ...
  out$.createTransaction = createTransaction = function (arg$, cb) {
    ...
    return asCallback(
      eos.transfer(from, recipient, amount, data, {
        broadcast: broadcast,
        sign: sign,
      }),
      function (err, tr) {
  ...
  out$.getBalance = getBalance = function (arg$, cb) {
    ...
    return get(
      network.api.apiUrl +
        '/api?module=account&action=get_account_balance&apikey=' +
        apikey +
        '&account=' +
        accountName
      ...
      balance =
        (ref$ = (ref1$ = data.body.data) != null ? ref1$.balance : void 8) !=
        null
          ? ref$
          : 0;
