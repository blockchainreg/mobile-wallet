...
(function(){
  ...
  out$.createTransaction = createTransaction = curry$(function(arg$, cb){
    var network, account, recipient, amount, amountFee, feeType, gasPrice, gas, txType, data, web3, dec, privateKey, from;
    network = arg$.network, account = arg$.account, recipient = arg$.recipient, amount = arg$.amount, amountFee = arg$.amountFee, feeType = arg$.feeType, gasPrice = arg$.gasPrice, gas = arg$.gas, txType = arg$.txType, data = arg$.data;
