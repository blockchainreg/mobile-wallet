...
(function(){
  ...
  prepareTxs = function(network, arg$, address, cb){
    ...
    return makeQuery(network, 'getConfirmedTransaction', [signature, 'jsonParsed'], function(err, data){
      var t, txData, sender, receiver, hash, senderIndex, amount, ref$, fee, status, transaction, accountKeys, instructions, type, ref1$, ref2$, senders, e, time, dec, url, cluster, customUrl, $cluster, uri, _type, recipientType, isStake, ref3$, txType, _tx;
      if (err != null) {
