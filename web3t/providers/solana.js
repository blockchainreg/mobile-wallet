...
(function () {
  ...
  out$.getAccount = getAccount = function (mnemonic, index, cb) {
    ...
    derivedSeed = bip32
      .fromSeed(seed)
      .derivePath("m/44'/5655640'/" + index + "'/0").privateKey;
  ...
  prepareTxs = function (network, arg$, address, cb) {
    ...
    return getTxData(network, signature, function (err, data) {
      ...
      if (err != null) {
        console.error(
          'Error occured while fetching tx details for signature:',
          signature
        );
      }
      t = [];
      if (err == null && data != null) {
        ...
        try {
          ...
          if (type === EVM_TO_NATIVE_SWAP) {
            ...
            hash =
              (ref2$ =
                transaction != null
                  ? (ref4$ = transaction.signatures) != null
                    ? ref4$[0]
                    : void 8
                  : void 8) != null
                ? ref2$
          ...
          if (type === 'withdraw') {
            sender =
              (ref2$ = instructions[0].parsed.info.stakeAccount) != null
                ? ref2$
          ...
          if (type == null) {
            ...
            hash = transaction.signatures[0];
            amount =
              (ref2$ = getSentAmount(txData)[receiver]) != null ? ref2$ : 0;
          }
        } catch (e$) {
          e = e$;
        ...
        (ref2$ = network.api),
          (url = ref2$.url),
          (cluster = ref2$.cluster),
          (customUrl = ref2$.customUrl);
        ...
        isStake =
          (ref2$ =
            (ref5$ = instructions[0]) != null
              ? (ref6$ = ref5$.parsed) != null
                ? ref6$.type
                : void 8
              : void 8) === 'stake' ||
