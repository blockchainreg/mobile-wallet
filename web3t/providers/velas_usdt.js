...
(function(){
	var stringify, ref$, filter, map, foldl, each, plus, minus, times, div, get, post, Web3, Tx, BN, hdkey, bip39, ethToVlx, vlxToEth, jsonParse, deadline, sha3, getEthereumFullpairByIndex, abi, getContractInstance, isAddress, calcFee, getKeys, toHex, transformTx, up, getTransactions, tryParse, makeQuery, getWeb3, getDec, calcGasPrice, round, createTransaction, checkDecodedData, pushTx, checkTxStatus, getTransactionInfo, getTotalReceived, getUnconfirmedBalance, getBalance, isValidAddress, isChecksumAddress, getMarketHistoryPrices, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
	...
	out$.createTransaction = createTransaction = curry$(function(arg$, cb){
		var network, account, recipient, amount, amountFee, feeType, txType, data, web3, dec, privateKey, from;
