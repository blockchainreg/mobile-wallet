...
(function () {
  ...
  out$.getTransactions = getTransactions = function (arg$, cb) {
    ...
    if (token == null || token.toString().trim().length === 0) {
      console.error(
        'ERC20 provider, [getTransactions] error: token is not defined'
      );
      return cb(null, []);
    }
    if (
      ...
      (network != null
        ? (ref1$ = network.api) != null
          ? ref1$.apikey.toString().trim().length
          : void 8
        : void 8) === 0
    ) {
      console.error(
        'ERC20 provider, [getTransactions] error: apikey is not defined'
      );
      return cb(null, []);
    }
  ...
  out$.createTransaction = createTransaction = curry$(function (arg$, cb) {
    ...
    (network = arg$.network),
      ...
      (swap = arg$.swap);
    if (
      (network != null ? network.txFeeIn : void 8) == null ||
      (network != null ? network.txFeeIn.toString().trim().length : void 8) ===
        0
    ) {
              ...
              function (err, gasEstimate) {
                ...
                return web3.eth.getBalance(
                  ...
                  function (err, balance) {
                    ...
                    parentToken = up(
                      network != null ? network.txFeeIn : void 8
                    );
                    if (+balanceEth < +amountFee) {
                      return cb(
                        parentToken + ' balance is not enough to send tx'
                      );
                    }
                    return getBalance(
                      {
