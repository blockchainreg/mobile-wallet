...
(function(){
  var stringify, ref$, filter, map, foldl, each, plus, minus, times, div, fromHex, $toHex, get, post, Web3, Tx, BN, hdkey, bip39, jsonParse, deadline, sha3, getEthereumFullpairByIndex, abi, getContractInstance, isAddress, calcFee, getGasEstimate, getKeys, toHex, transformTx, up, getTransactions, getWeb3, getDec, calcGasPrice, round, getNonce, createTransaction, checkDecodedData, pushTx, checkTxStatus, getTotalReceived, getUnconfirmedBalance, getBalance, isValidAddress, tryParse, makeQuery, getTransactionInfo, isChecksumAddress, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
        ...
        return getGasEstimate({
          ...
          return web3.eth.getBalance(account.address, function(err, balance){
            ...
            if (+balanceEth < +amountFee) {
              return cb("ETH Legacy balance (" + balanceEth + ") is not enough to send tx");
            }
            return getBalance({
              network: network,
              address: account.address
