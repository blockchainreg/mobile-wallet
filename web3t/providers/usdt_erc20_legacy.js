...
(function(){
  var stringify, ref$, filter, map, foldl, each, plus, minus, times, div, get, post, Web3, Tx, BN, hdkey, bip39, jsonParse, deadline, sha3, getEthereumFullpairByIndex, abi, getContractInstance, isAddress, calcFee, getKeys, toHex, transformTx, up, getTransactions, getWeb3, getDec, calcGasPrice, round, createTransaction, checkDecodedData, pushTx, checkTxStatus, getTotalReceived, getUnconfirmedBalance, getBalance, isValidAddress, tryParse, makeQuery, getTransactionInfo, isChecksumAddress, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
  ...
  transformTx = curry$(function(network, t){
    var url, dec, tx, amount, time, fee, from;
    url = network.api.url;
    dec = getDec(network);
    network = 'eth';
    tx = t.hash;
  ...
  out$.createTransaction = createTransaction = curry$(function(arg$, cb){
    var network, account, recipient, amount, amountFee, feeType, txType, data, web3, dec, privateKey;
    network = arg$.network, account = arg$.account, recipient = arg$.recipient, amount = arg$.amount, amountFee = arg$.amountFee, feeType = arg$.feeType, txType = arg$.txType, data = arg$.data;
