...
(function () {
  ...
  out$.getBalance = getBalance = function (arg$, cb) {
    ...
    return get(network.api.url + '/api/addr/' + address + '/balance').end(
      function (err, data) {
        var dec, num;
  ...
  transformTx = curry$(function (net, t) {
    ...
    to =
      (ref$ = t.vout) != null
        ? typeof ref$.filter == 'function'
          ? (ref1$ = ref$.filter(sameValue)) != null
            ? (ref2$ = ref1$.map(function (it) {
                var ref$, ref1$;
                return (ref$ = it.scriptPubKey) != null
                  ? (ref1$ = ref$.addresses) != null
                    ? ref1$[0]
                    : void 8
                  : void 8;
              })) != null
  ...
  out$.getTransactions = getTransactions = function (arg$, cb) {
    ...
    return get(network.api.url + '/api/txs/?address=' + address).end(function (
      err,
      data
    ) {
      if (err != null) {
      ...
      jsonParse(data.text, function (err, result) {
        ...
        if (
          toString$.call(result != null ? result.txs : void 8).slice(8, -1) !==
          'Array'
        ) {
          return cb('Unexpected result');
        }
        txs = map(transformTx(network))(result.txs);
        return cb(null, txs);
      });
    });
  };
