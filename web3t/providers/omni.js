...
(function(){
  var stringify, ref$, filter, map, foldl, each, find, sum, values, plus, minus, times, div, get, post, jsonParse, deadline, BitcoinLib, bip39, getBitcoinFullpairByIndex, calcFeePerByte, calcDynamicFee, getCalcFeeFunc, calcFeePrivate, calcFeeInstantx, calcFee, getKeys, extend, getDec, addAmount, extendNum, toHex, getApiUrl, getOutputs, addValue, addOutputs, createTransaction, transformTx, getTransactions, checkDecodedData, pushTx, checkTxStatus, str, getTotalReceived, getUnconfirmedBalance, getData, getBalance, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
