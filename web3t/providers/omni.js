...
(function () {
        ...
        return getBalance(
          ...
          function (err, omniBalance) {
            ...
            simple_send = [
              '6f6d6e69',
              toHex(0, 4),
              toHex(network.propertyid, 12),
              toHex(value, 16),
            ];
            data = Buffer.from(simple_send.join(''), 'hex');
            omniOutput = BitcoinLib.script.compile([
  ...
  out$.getTransactions = getTransactions = function (arg$, cb) {
    ...
    return post(apiUrl + '/v1/address/addr/details/', req)
      .type('form')
      .end(function (err, data) {
        var ref$, txs;
        if (err != null) {
        ...
        if (
          toString$
            .call((ref$ = data.body) != null ? ref$.transactions : void 8)
            .slice(8, -1) !== 'Array'
        ) {
  ...
  out$.getBalance = getBalance = function (arg$, cb) {
    ...
    return post(apiUrl + '/v1/address/addr/', req)
      .type('form')
      .end(function (err, data) {
        if (err != null) {
          return cb(err);
        ...
        return getData(data, function (err, body) {
          ...
          if (
            toString$
              .call(body != null ? body.balance : void 8)
              .slice(8, -1) !== 'Array'
          ) {
