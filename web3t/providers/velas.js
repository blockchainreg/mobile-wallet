...
(function () {
  ...
  VelasCrypto = require('../node_modules_embed/vlx-wallet/Crypto/index.js')[
    'default'
  ];
  ...
  out$.getTransactions = getTransactions = function (arg$, cb) {
    ...
    txs =
      (ref$ = (ref1$ = data.body) != null ? ref1$.items : void 8) != null
        ? ref$
        : [];
    ...
    newTxs = map(transformTx(network))(txs);
  ...
  out$.getTransactions = getTransactions = function (arg$, cb) {
    ...
    (network = arg$.network), (address = arg$.address);
    return get(
      'https://oldexplorer.velas.com/history-api/' + address + '/txs'
  ...
  getUnspents = function (arg$, cb) {
    ...
    return get(baseUrl + '/wallet/unspent/' + address).end(function (err, res) {
      ...
      if (toString$.call(unspentsNative).slice(8, -1) !== 'Array') {
        return cb(
          'expected array, got ' + toString$.call(unspentsNative).slice(8, -1)
        );
      }
      if (err != null) {
        return cb(err);
  ...
  out$.getBalance = getBalance = function (arg$, cb) {
    ...
    return get(
      'https://oldexplorer.velas.com/api/v1/wallet/balance/' + address
    ).end(function (err, data) {
      if (err != null) {
        return cb(err);
      }
