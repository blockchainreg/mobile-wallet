...
(function(){
  var stringify, ref$, filter, map, foldl, each, sortBy, reverse, plus, minus, times, div, fromHex, $toHex, get, post, Web3, Tx, BN, hdkey, bip39, jsonParse, deadline, decode, encode, Common, vlxToEth, ethToVlx, sha3, bignumber, isChecksumAddress, isAddress, toVelasAddress, toEthAddress, isValidAddress, getEthereumFullpairByIndex, tryParse, makeQuery, getTransactionInfo, getGasEstimate, calcFee, getKeys, round, toHex, up, transformTx, getInternalTransactions, getExternalTransactions, getTransactions, getDec, calcGasPrice, tryGetLatest, getNonce, createTransaction, checkDecodedData, pushTx, checkTxStatus, getTotalReceived, getUnconfirmedBalance, getBalance, getMarketHistoryPrices, getSyncStatus, getPeerCount, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
  ...
  transformTx = curry$(function(network, description, t){
    ...
    txType = (function(){
      ...
      case !(up(t.from) === up("V8sA8Q5jR44E4q6S59eUhhSJQiRBBFdZA8") || up(t.from) === up("0x56454c41532d434841494e000000000053574150")):
        return "Native to EVM Swap";
      default:
        return null;
      }
    }());
  ...
  getInternalTransactions = function(config, cb){
    ...
    return toEthAddress(config.address, function(err, address){
