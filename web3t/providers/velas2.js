...
(function () {
  ...
  transformTx = curry$(function (network, description, t) {
    ...
    txType = (function () {
      switch (false) {
        case !(
          t.to === 'V8sA8Q5jR44E4q6S59eUhhSJQiRBBFdZA8' ||
          t.to === '0x56454c41532d434841494e000000000053574150'
        ):
          return 'Swap EVM to Native';
        case !(
          up(t.from) === up('V8sA8Q5jR44E4q6S59eUhhSJQiRBBFdZA8') ||
          up(t.from) === up('0x56454c41532d434841494e000000000053574150')
        ):
