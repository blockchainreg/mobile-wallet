...
(function(){
  ...
  transformTx = curry$(function(network, description, t){
	var url, dec, tx, amount, time, gasUsed, ref$, gasPrice, fee, recipientType;
	url = network.api.url;
	dec = getDec(network);
	network = 'eth';
	tx = (function(){
