...
(function () {
  ...
  stringToHex = function (str) {
    return (function (it) {
      return '0x' + it;
    })(toHexString(utils.toUtf8Bytes(str)));
  };
  calcFee = function (arg$, cb) {
    ...
    if (
      ((ref$ = network.txFeeOptions) != null ? ref$.withdraw : void 8) === 0
    ) {
      return cb(null, 0);
    }
    if (
      ((ref1$ = network.txFeeOptions) != null ? ref1$.withdraw : void 8) !==
      '50 + 2%'
    ) {
  ...
  module.exports =
    ((ref$ = {}),
    import$(ref$, eth),
    (ref$.createTransaction = createTransaction),
    (ref$.calcFee = calcFee),
    ref$);
