...
(function(){
  ...
  getGasEstimate = function(arg$, cb){
    var network, query, gas, swap, ref$, ref1$;
    network = arg$.network, query = arg$.query, gas = arg$.gas, swap = arg$.swap;
    if (((ref$ = network != null ? (ref1$ = network.api) != null ? ref1$.web3Provider : void 8 : void 8) != null ? ref$ : "").indexOf("ropsten") === -1) {
      gas = (function(){
        switch (false) {
        case swap !== true:
          return 200000;
    ...
    return makeQuery(network, 'eth_estimateGas', [query], function(err, estimate){
      ...
      if (estimateNormal < 150000) {
        return cb(null, 150000);
      }
      return cb(null, estimateNormal);
    });
  };
  out$.calcFee = calcFee = function(arg$, cb){
    var network, feeType, account, amount, to, data, gasPrice, gas, swap, dec;
    network = arg$.network, feeType = arg$.feeType, account = arg$.account, amount = arg$.amount, to = arg$.to, data = arg$.data, gasPrice = arg$.gasPrice, gas = arg$.gas, swap = arg$.swap;
  ...
  out$.getTransactions = getTransactions = function(arg$, cb){
    ...
    return get(apiUrl + "?" + query).timeout({
      ...
      return jsonParse(resp.text, function(err, result){
        ...
        filter(function(it){
          return up(it.contractAddress) === up(network.address) && up(it.tokenSymbol) === 'VLX';
        })(
        result.result)));
        return cb(null, txs);
      });
  ...
  out$.calcGasPrice = calcGasPrice = function(arg$, cb){
    var feeType, network, gasPrice, swap, GAS_PRICE_AVERAGE, ref$, ref1$, ref2$;
    feeType = arg$.feeType, network = arg$.network, gasPrice = arg$.gasPrice, swap = arg$.swap;
    GAS_PRICE_AVERAGE = 69000000000;
    if (gasPrice != null && ((ref$ = network != null ? (ref1$ = network.api) != null ? ref1$.web3Provider : void 8 : void 8) != null ? ref$ : "").indexOf("ropsten") === -1) {
      return cb(null, gasPrice);
    }
    if (((ref$ = network != null ? (ref2$ = network.api) != null ? ref2$.web3Provider : void 8 : void 8) != null ? ref$ : "").indexOf("ropsten") === -1) {
      return cb(null, GAS_PRICE_AVERAGE);
    }
