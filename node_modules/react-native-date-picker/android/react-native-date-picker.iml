...
<module external.linked.project.id=":react-native-date-picker" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: com.henninghall.android:NumberPickerView:1.1.0@aar" level="project" />
    ...
    <orderEntry type="library" name="Gradle: net.time4j:time4j-android:4.2-2018i@aar" level="project" />
