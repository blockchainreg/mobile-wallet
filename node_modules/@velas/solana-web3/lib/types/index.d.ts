...
declare class PublicKey {
     ...
     */
    static findProgramAddress(seeds: Array<Buffer | Uint8Array>, programId: PublicKey): Promise<[
        PublicKey,
        number
    ]>;
}
 ...
 * @internal
 */
declare const FeeCalculatorLayout: any;
/**
...
declare const NONCE_ACCOUNT_LENGTH: any;
 ...
 * @internal
 */
declare const BLOCKHASH_CACHE_TIMEOUT_MS: number;
 ...
 */
type Commitment = "processed" | "confirmed" | "finalized" | "recent" // Deprecated as of v1.5.5
 ...
 */
declare const GetConfirmedBlockRpcResult: Struct<{
    jsonrpc: "2.0";
    id: string;
    result: {
        blockTime: number | null;
...
declare class Connection {
    ...
    /** @internal */ _rpcWebSocketConnected: boolean;
    /** @internal */ _rpcWebSocketHeartbeat: ReturnType<typeof setInterval> | null;
    /** @internal */ _rpcWebSocketIdleTimeout: ReturnType<typeof setTimeout> | null;
    /** @internal */ _disableBlockhashCaching: boolean;
    /** @internal */ _pollingBlockhash: boolean;
     ...
     */
    getProgramAccounts(programId: PublicKey, commitment?: Commitment): Promise<Array<{
        pubkey: PublicKey;
        account: AccountInfo<Buffer>;
    }>>;
    /**
     ...
     */
    getParsedProgramAccounts(programId: PublicKey, commitment?: Commitment): Promise<Array<{
        pubkey: PublicKey;
     ...
     */
    getConfirmedTransaction(signature: TransactionSignature): Promise<ConfirmedTransaction | null>;
    /**
     * Fetch parsed transaction details for a confirmed transaction
     */
    getParsedConfirmedTransaction(signature: TransactionSignature): Promise<ParsedConfirmedTransaction | null>;
    /**
     * Fetch parsed transaction details for a batch of confirmed transactions
     */
    getParsedConfirmedTransactions(signatures: TransactionSignature[]): Promise<(ParsedConfirmedTransaction | null)[]>;
    /**
     ...
     * @param options
     */
    getConfirmedSignaturesForAddress2(address: PublicKey, options?: ConfirmedSignaturesForAddress2Options): Promise<Array<ConfirmedSignatureInfo>>;
    /**
     ...
     */
    simulateTransaction(transaction: Transaction, signers?: Array<Account>): Promise<RpcResponseAndContext<SimulatedTransactionResponse>>;
    /**
     * Sign and send a transaction
     */
    sendTransaction(transaction: Transaction, signers: Array<Account>, options?: SendOptions): Promise<TransactionSignature>;
    /**
    ...
    }, rpcMethod: string, rpcArgs: IWSRequestParams): Promise<void>;
    /**
     * @internal
     */
    _unsubscribe(sub: {
        subscriptionId: SubscriptionId | null;
    }, rpcMethod: string): Promise<void>;
    /**
     * @internal
     */
     ...
     * @internal
     */
    _wsOnAccountNotification(notification: object): void;
    /**
...
declare class BpfLoader {
     ...
     */
    static load(connection: Connection, payer: Account, program: Account, elf: Buffer | Uint8Array | Array<number>, loaderProgramId: PublicKey): Promise<boolean>;
}
/**
...
declare class Loader {
     ...
     * @return true if program was loaded successfully, false if program was already loaded
     */
    static load(connection: Connection, payer: Account, program: Account, programId: PublicKey, data: Buffer | Uint8Array | Array<number>): Promise<boolean>;
}
/**
 ...
 */
type StakeInstructionType = "AuthorizeWithSeed" | "Authorize" | "Deactivate" | "Delegate" | "Initialize" | "Split" | "Withdraw";
/**
 * An enumeration of valid stake InstructionType's
 */
declare const STAKE_INSTRUCTION_LAYOUTS: {
...
declare class SystemInstruction {
     ...
     */
    static decodeTransferWithSeed(instruction: TransactionInstruction): TransferWithSeedParams;
    /**
 ...
 */
type SystemInstructionType = "AdvanceNonceAccount" | "Allocate" | "AllocateWithSeed" | "Assign" | "AssignWithSeed" | "AuthorizeNonceAccount" | "Create" | "CreateWithSeed" | "InitializeNonceAccount" | "Transfer" | "TransferWithSeed" | "WithdrawNonceAccount";
/**
 * An enumeration of valid system InstructionType's
 */
declare const SYSTEM_INSTRUCTION_LAYOUTS: {
 ...
 */
declare function sendAndConfirmTransaction(connection: Connection, transaction: Transaction, signers: Array<Account>, options?: ConfirmOptions): Promise<TransactionSignature>;
/**
...
export { Account, Blockhash, BPF_LOADER_DEPRECATED_PROGRAM_ID, BPF_LOADER_PROGRAM_ID, BpfLoader, BLOCKHASH_CACHE_TIMEOUT_MS, RpcParams, TokenAccountsFilter, Context, SendOptions, ConfirmOptions, ConfirmedSignaturesForAddress2Options, RpcResponseAndContext, Commitment, LargestAccountsFilter, GetLargestAccountsConfig, SignatureStatusConfig, ContactInfo, VoteAccountInfo, VoteAccountStatus, InflationGovernor, EpochInfo, EpochSchedule, LeaderSchedule, Version, SimulatedTransactionResponse, ParsedInnerInstruction, TokenBalance, ParsedConfirmedTransactionMeta, CompiledInnerInstruction, ConfirmedTransactionMeta, ConfirmedTransaction, PartiallyDecodedInstruction, ParsedMessageAccount, ParsedInstruction, ParsedMessage, ParsedTransaction, ParsedConfirmedTransaction, ConfirmedBlock, PerfSample, Supply, TokenAmount, TokenAccountBalancePair, AccountBalancePair, GetConfirmedBlockRpcResult, SlotInfo, ParsedAccountData, StakeActivationData, AccountInfo, KeyedAccountInfo, AccountChangeCallback, ProgramAccountChangeCallback, SlotChangeCallback, SignatureResultCallback, SignatureStatusNotification, SignatureReceivedNotification, SignatureSubscriptionCallback, SignatureSubscriptionOptions, RootChangeCallback, Logs, LogsFilter, LogsCallback, SignatureResult, TransactionError, TransactionConfirmationStatus, SignatureStatus, ConfirmedSignatureInfo, Connection, FeeCalculatorLayout, FeeCalculator, Loader, MessageHeader, CompiledInstruction, MessageArgs, Message, NONCE_ACCOUNT_LENGTH, NonceAccount, MAX_SEED_LENGTH, PublicKey, STAKE_CONFIG_ID, Authorized, Lockup, CreateStakeAccountParams, CreateStakeAccountWithSeedParams, InitializeStakeParams, DelegateStakeParams, AuthorizeStakeParams, AuthorizeWithSeedStakeParams, SplitStakeParams, WithdrawStakeParams, DeactivateStakeParams, StakeInstruction, StakeInstructionType, STAKE_INSTRUCTION_LAYOUTS, StakeAuthorizationType, StakeAuthorizationLayout, StakeProgram, CreateAccountParams, TransferParams, AssignParams, CreateAccountWithSeedParams, CreateNonceAccountParams, CreateNonceAccountWithSeedParams, InitializeNonceParams, AdvanceNonceParams, WithdrawNonceParams, AuthorizeNonceParams, AllocateParams, AllocateWithSeedParams, AssignWithSeedParams, TransferWithSeedParams, SystemInstruction, SystemInstructionType, SYSTEM_INSTRUCTION_LAYOUTS, SystemProgram, CreateSecp256k1InstructionWithPublicKeyParams, CreateSecp256k1InstructionWithEthAddressParams, CreateSecp256k1InstructionWithPrivateKeyParams, Secp256k1Program, TransactionSignature, PACKET_DATA_SIZE, AccountMeta, TransactionInstructionCtorFields, SerializeConfig, TransactionInstruction, Transaction, VALIDATOR_INFO_KEY, Info, ValidatorInfo, VOTE_PROGRAM_ID, Lockout, EpochCredits, VoteAccount, SYSVAR_CLOCK_PUBKEY, SYSVAR_RECENT_BLOCKHASHES_PUBKEY, SYSVAR_RENT_PUBKEY, SYSVAR_REWARDS_PUBKEY, SYSVAR_STAKE_HISTORY_PUBKEY, SYSVAR_INSTRUCTIONS_PUBKEY, sendAndConfirmTransaction, sendAndConfirmRawTransaction, Cluster, clusterApiUrl, LAMPORTS_PER_SOL };
