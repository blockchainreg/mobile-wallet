...
export default class TabsValidator extends Component {
  constructor(props) {
    super(props);
    this.state = { page: 0 };
  }
        ...
        <View>
          ...
          >
            <Tab
              ...
              heading={
                <TabHeading style={{ backgroundColor: Images.velasColor4 }}>
                  <ValidatorsIcon
                    fill={
                      this.state.page === 0 ? Images.colorGreen : GRAY_COLOR
                    }
                    type={"STAKE"}
                  />
                  <Text
            ...
            >
              ...
              {/* <View>
                <ButtonBlock type={"STAKE_MORE"} onPress={changePage("history")}/>
                <ButtonBlock type={"REQUEST_WITHDRAW"} />
              </View> */}
            </Tab>
            ...
            <Tab
              ...
              heading={
                <TabHeading style={{ backgroundColor: Images.velasColor4 }}>
                  <ValidatorsIcon
                    fill={
                      this.state.page === 1 ? Images.colorGreen : GRAY_COLOR
                    }
                    type={"WITHDRAW"}
                  />
                  <Text
            ...
            tabStyle={{backgroundColor: "pink", height: "100%"}}
              ...
              heading={
                <TabHeading style={{ backgroundColor: Images.velasColor4 }}>
                  <ValidatorsIcon
                    fill={
                      this.state.page === 2 ? Images.colorGreen : GRAY_COLOR
                    }
                    type={"REWARDS"}
                  />
                  <Text
