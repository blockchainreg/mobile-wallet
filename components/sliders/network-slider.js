...
const NetworkChooser = (props) => {
  ...
  const openBridgeDetailsModal = () => {
    ...
    store.current.currentNetworkDetails.remainingDailyLimit =
      remainingDailyLimit;
    ...
    <View style={{ marginBottom: 10 }}>
      <View style={[style.alignHorizontal, { marginBottom: 5 }]}>
        <View style={[styles.titleInputSend, style.itemWidth70]}>
          <Text style={style.headerBg}>
            {lang.chosenNetwork || 'Choose network'}:
          </Text>
        </View>
      ...
      <RNPickerSelect
        ...
        Icon={() => (
          <Icon
            ...
            size={15}
            color="white"
            style={[{ right: 5, top: 15, position: 'absolute' }]}
          />
        )}
